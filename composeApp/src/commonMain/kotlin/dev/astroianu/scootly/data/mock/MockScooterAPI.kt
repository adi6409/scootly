...
class MockScooterAPI: ScooterAPI {
    private val scootersByProvider = mapOf(
        ...
        "bird_tel_aviv" to listOf(
            Scooter(
                ...
                providerName = "Bird",
                providerIcon = "https://downloadr2.apkmirror.com/wp-content/uploads/2018/07/5b47c64218d9b.png",
                latitude = 32.1150055,
    ...
    override suspend fun getScooters(provider: Provider): List<Scooter> {
        return scootersByProvider[provider.id] ?: emptyList()
    }
}